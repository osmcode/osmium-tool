...
if(Osmium_USE_PROJ)
    ...
    if(PROJ_INCLUDE_DIR)
        if(Osmium_DEBUG)
            message(STATUS "Found proj_api.h - Using old PROJ api")
        endif()
        add_definitions(-DOSMIUM_USE_PROJ_API_H)
    else()
        find_path(PROJ_INCLUDE_DIR proj.h)
        if(PROJ_INCLUDE_DIR)
            if(Osmium_DEBUG)
                message(STATUS "Found proj.h - Using new PROJ api")
            endif()
            add_definitions(-DOSMIUM_USE_PROJ_H)
        endif()
    endif()
    ...
    if(PROJ_INCLUDE_DIR AND PROJ_LIBRARY)
        ...
        message(WARNING "Osmium: PROJ library is required but not found, please install it or configure the paths.")
    endif()
endif()
